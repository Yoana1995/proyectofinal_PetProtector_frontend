...
<template>
    <div v-if="validToken">
        <h1 class="text-6xl font-extrabold text-blue-800 text-center mt-10">Nuevo Password</h1>
        <p class="text-2xl text-blue-500 text-center my-5">Coloca tu nuevo password</p>
